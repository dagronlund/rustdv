...
> ⛔ **SUPERSEDED — DO NOT FOLLOW THIS DOCUMENT.** This is the original
> (2026-07-07) pre-implementation specification. Its closed-world design —
> removing UVM's dynamic build/connect process and the TLM FIFOs — is exactly
> what the UVM restoration exists to undo. It is retained only as the record
> of what went wrong. The authoritative source for the design is
> `output/.design-decisions.md` (start at its §0); where the two disagree,
> the decision log wins, always. See TOUR.md and CLAUDE.md.
